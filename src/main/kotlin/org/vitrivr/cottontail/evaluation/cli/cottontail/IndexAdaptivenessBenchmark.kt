    ...
    private fun prepare() {
        ...
        try {
            ...
            when(this.index) {
                ...
                CottontailGrpc.IndexType.IVFPQ -> this.client.create(CreateIndex(TEST_ENTITY_NAME, "feature", CottontailGrpc.IndexType.IVFPQ).param("ivfpq.centroids", "2048").param("ivfpq.subspaces","8").param("ivfpq.coarse_centroids","256").name(INDEX_NAME))
